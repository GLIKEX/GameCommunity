...
public class IBmsPostServiceImpl extends ServiceImpl<BmsPostMapper, BmsPost> implements IBmsPostService {
    ...
    public BmsPost create(CreateTopicDTO dto, User user) {
        ...
        if (!ObjectUtils.isEmpty(dto.getTags())) {
            ...
            // 处理标签与话题的关联
            iBmsPostTagService.createTopicTag(topic.getId(), tags);
        }
    ...
    public Map<String, Object> viewTopic(String id) {
        ...
        wrapper.lambda().eq(BmsPostTag::getGameId, topic.getId());
        Set<String> set = new HashSet<>();
        for (BmsPostTag articleTag : iBmsPostTagService.list(wrapper)) {
    ...
    private void setTopicTags(Page<PostVO> iPage) {
        iPage.getRecords().forEach(topic -> {
            List<BmsPostTag> topicTags = iBmsPostTagService.selectByTopicId(topic.getId());
